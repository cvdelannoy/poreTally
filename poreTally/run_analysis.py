...
def main(args):
    ...
    for anl in assemblies_names_list:
        ...
        quast_output_cmd += 'cp contigs_reports/nucmer_output/{anl}.fplot {{output.{anl}_fplot}}\n'.format(anl=anl)
        quast_output_cmd += 'cp contigs_reports/nucmer_output/{anl}.rplot {{output.{anl}_rplot}}\n'.format(anl=anl)
